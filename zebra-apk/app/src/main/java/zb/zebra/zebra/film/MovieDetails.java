...
public class MovieDetails implements Parcelable {
    ...
    public MovieDetails(Long id,String name, String director, String plot, String cast, String rating, String releasedate, String movie_image, List<String> genres, String imdb_id, int duration_secs, String duration) {
        this.id = id;
        this.name = name;
