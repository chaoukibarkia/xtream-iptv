 ...
 */
public final class IPTVTrackSelectionHelper implements View.OnClickListener {
   ...
   */
  public IPTVTrackSelectionHelper(DefaultTrackSelector selector, Context context) {
