...
public class IptvActivity extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaDataSourceFactory = new DefaultHttpDataSourceFactory("IPTVAPPLICATION",null, DefaultHttpDataSource.DEFAULT_CONNECT_TIMEOUT_MILLIS,
                DefaultHttpDataSource.DEFAULT_READ_TIMEOUT_MILLIS,
                true);

        simpleExoPlayerView = (SimpleExoPlayerView) findViewById(R.id.surface_view);
        ...
        trackSelectionHelper = new IPTVTrackSelectionHelper(trackSelector, adaptiveTrackSelectionFactory);
            ...
            public void onClick(View view) {
                if(trackSelector.getCurrentMappedTrackInfo()!=null) {
                    ...
                    audiomenulist.addView(trackSelectionHelper.buildView(
                            IptvActivity.this, 1, trackSelector.getCurrentMappedTrackInfo(),(ConstraintLayout) findViewById(R.id.iptvconstraint),"audio"));
            ...
            public void onClick(View view) {
                if(trackSelector.getCurrentMappedTrackInfo()!=null) {
                    ...
                    subtitlemenulist.addView(trackSelectionHelper.buildView(
                            IptvActivity.this, 2,trackSelector.getCurrentMappedTrackInfo(),(ConstraintLayout) findViewById(R.id.iptvconstraint),"subtitle"));
